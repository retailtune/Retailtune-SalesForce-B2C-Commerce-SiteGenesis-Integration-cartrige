    ...
    update: function (object) {
        ...
        if (object.class) {
            ...
            if (!title && 'name' in object) {
                title = object.name;
                //set a string by default for meta tag then if there are the correct pagemetadata it will be replace
                this.data.page.description = object.name;
                this.data.page.keywords = object.name;
            } else if (!title && 'displayName' in object) {
                title = object.displayName;
                //set a string by default for meta tag then if there are the correct pagemetadata it will be replace
                this.data.page.description = object.displayName;
                this.data.page.keywords = object.displayName;
            }
